      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="space-y-6">
          <div className="hero-panel">
            ...
            <h2 className="mt-4 text-4xl font-black tracking-tight text-slate-950">Welcome back, {currentUser.name}</h2>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="metric-card bg-rose-700"><span>Fine to be paid by you</span><strong>Rs. {yourFineDue}</strong></div>
            </div>
          </div>
