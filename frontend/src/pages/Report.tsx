...
const Report: React.FC<ReportPageProps> = ({ appliances, users, currentUser, onSubmit }) => (
  <section className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
    ...
    <ReportForm appliances={appliances} users={users.filter((user) => user.id !== currentUser.id)} reporterId={currentUser.id} onSubmit={onSubmit} />
  </section>
);
